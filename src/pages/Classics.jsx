...
const newId = id.pid
  useEffect(() => {
    fetch("https://e-commerce-backend-kd0gzurq9-meenakshipillai20.vercel.app/classics")
      .then((res) => res.json())
      .then((json) => setData(json))
      .catch(err => console.log("error => ",err))
  },[]);
  useEffect(() => {
    fetch(`https://e-commerce-backend-kd0gzurq9-meenakshipillai20.vercel.app/classics/${newId}`)
      .then((res) => res.json())
  ...
  return (
    <>
      ...
      <div className="side-bar text-center mb-4 resp-item-header">
        <p className="text-primary p-2">Classics</p>
      </div>
              ...
              data.map((val) => {
                return (
                  <>
                    ...
                    <NavLink to={"/classics/"+val.id} activeclassname="active" className="text-decoration-none text-dark">
                       {val.type}
                    </NavLink>
